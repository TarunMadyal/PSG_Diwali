...
export function CatalogManager(){
  ...
  return <div className="owner-shell"><OwnerHeader/><main className="owner-main">
    <div className="owner-heading"><div><h1>Catalog & inventory</h1><p>Images, bilingual names, prices and exact variant stock</p></div><button className="primary" onClick={()=>{const c=categories[0];const id=crypto.randomUUID();setProducts((all)=>[...all,{id,categoryId:c.id,nameEn:"New product",nameKn:"ಹೊಸ ಉತ್ಪನ್ನ",pricePaise:0,imageUrl:"/demo/product-1.svg",sortOrder:all.length*10,active:false,variants:[]}]);}}>+ Add product</button></div>
